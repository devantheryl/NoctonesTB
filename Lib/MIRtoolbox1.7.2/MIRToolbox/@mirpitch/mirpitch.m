...
%                 plot(log10(dh))
                ...
                while k <= acts
                    ...
                    if dh(round(f0s(a).meanf0(end) / difffj* 10)) < .2
                        active(k) = [];
                        acts = acts - 1;
                        continue
                    end
...
%                                     ff = sets(l).meanf0;
                                    ...
                                    if ~transfered && sets(l).globmg > 400 ....5 ...
                                            && sets(l).mgs(1) ...
                                            ...&& sets(l).mgs(2) ...
...
%                                             end
    ...
    k = 1;
    while k <= length(f0s)
        if length(find(f0s(k).meanf0)) < 10 %5
            f0s(k) = [];
        else
            k = k + 1;
        end
...
elseif strcmpi(option.segm,'Lartillot2')
    for i = 1:length(pf)
        for j = 1:length(pf{i})
